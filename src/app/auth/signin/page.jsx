        ...
        <div className="backdrop-blur-xl bg-gray-900/50 rounded-3xl shadow-2xl shadow-green-500/5 border border-gray-700/40 px-8 py-10">
          ...
          <div className="flex justify-center">
            <button
              ...
              className="flex items-center justify-center gap-2 py-2.5 px-8 rounded-xl bg-gray-800/50 border border-gray-700/60 text-sm font-medium text-gray-300 hover:bg-gray-800/70 hover:shadow-md transition-all duration-200 cursor-pointer disabled:opacity-60"
            >
              {googleLoading ? (

      ...
      <div className="relative w-full max-w-md mx-4">
        <div className="backdrop-blur-xl bg-gray-900/50 rounded-3xl shadow-2xl shadow-green-500/5 border border-gray-700/40 px-8 py-10">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  value={form.password}
                  onChange={handleChange}
                  className="w-full pl-10 pr-11 py-3 rounded-xl bg-gray-800/60 border border-gray-600/60 text-gray-100 placeholder:text-gray-500 outline-none focus:border-emerald-400 focus:ring-2 focus:ring-emerald-500/30 transition-all duration-200"
                  required/>
                <button
                  type="button"
            ...
            <button
              type="submit"
              className="w-full py-3 rounded-xl bg-gradient-to-r from-green-500 to-emerald-500 text-white font-semibold text-base shadow-lg shadow-green-500/30 hover:shadow-xl hover:shadow-green-500/40 hover:scale-[1.02] active:scale-[0.98] transition-all duration-200 cursor-pointer">
              Sign Up
            </button>
          </form>
          ...
          <div className="">
            <button
              type="button"
              className="mx-auto flex items-center justify-center gap-2 py-2.5 px-6 rounded-xl bg-gray-800/50 border border-gray-700/60 text-sm font-medium text-gray-300 hover:bg-gray-800/70 hover:shadow-md transition-all duration-200 cursor-pointer">

...
const SignupPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (error) return setError(error.message || "Signup failed. Please try again.");
        ...
        <div className="backdrop-blur-xl bg-gray-900/50 rounded-3xl shadow-2xl shadow-green-500/5 border border-gray-700/40 px-8 py-10">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              ...
              <p className="text-xs text-gray-500 mt-1.5">Must be at least 8 characters with 1 uppercase and 1 number</p>
            </div>
          ...
          <div className="flex justify-center">
            <button
              ...
              className="flex items-center justify-center gap-2 py-2.5 px-8 rounded-xl bg-gray-800/50 border border-gray-700/60 text-sm font-medium text-gray-300 hover:bg-gray-800/70 hover:shadow-md transition-all duration-200 cursor-pointer disabled:opacity-60 disabled:cursor-not-allowed"
            >
              {googleLoading ? (
          ...
          <p className="text-center text-sm text-gray-400 mt-8">
            ...
            <Link href="/auth/signin" className="text-emerald-400 font-medium hover:text-emerald-300 underline underline-offset-2 transition-colors">
              Sign In
            </Link>
          </p>
        </div>
